 ...
 * @author fnajer
 */
public class StatementTagParser extends Parser {
    protected int num;
    protected final int startRow; // used by tags
    protected BalanceTable balanceTable;
    protected final ObservableList<ContractData> dataList;
    
    StatementTagParser(ObservableList<ContractData> dataList, int indexStartRow) {
        super();
        this.dataList = dataList;
        this.startRow = indexStartRow + 1;
        this.num = 1;
        useContractData(dataList.get(0));
    }
    
    @Override
    protected void useContractData(ContractData data) {
        super.useContractData(data);
        BalanceTable balanceTable = period.getBalanceTable();
        this.balanceTable = balanceTable == null ? new BalanceTable() : balanceTable;
    }
